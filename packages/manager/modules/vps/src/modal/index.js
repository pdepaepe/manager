...
angular
  ...
  .controller('AddBackupStorageCtrl', AddBackupStorageCtrl)
  .controller('DeleteBackupStorageCtrl', DeleteBackupStorageCtrl)
  .controller('EditBackupStorageCtrl', EditBackupStorageCtrl)
  .controller('PasswordBackupStorageCtrl', PasswordBackupStorageCtrl)
  .controller('VpsOptionTerminateCtrl', VpsOptionTerminateCtrl)
  .controller('AddSecondaryDnsCtrl', AddSecondaryDnsCtrl)
  .controller('DeleteSecondaryDnsCtrl', DeleteSecondaryDnsCtrl)
